(async()=>{
    ...
    // blockly code
    var embed_title, embed_description, embed_image, embed_color;
    ...
    s4d.joiningMember = param1;
      (s4d.joiningMember).send({embeds: [{
      color: String('#ff0000'),
      title: String('👋 Bienvenue sur Red Unit !'),
